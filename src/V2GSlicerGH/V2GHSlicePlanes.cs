...
{
    public class V2GHSlicePlanes : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the V2GHSlicePlanes class.
        /// </summary>
        public V2GHSlicePlanes()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            SlicePlanes = V2GSlicer.V2GSlicePlanes(Geometry, LayerHeight, OffsetBottomGlobal, OffsetBottom, OffsetTop);
        ...
        {
            get { return new Guid("{968e81b0-da41-4557-beca-9bfbf48cc7b1}"); }
        }
    }
}